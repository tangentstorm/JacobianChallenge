...
biholomorphisms (as proved in section 02), so they force the source
...
input from section 02); biholomorphic surfaces have isomorphic spaces
...
\(s\in\Sym^{g-1}(X)\), where \(\kappa\) is the Riemann constant and
\(\AJ_{g-1}\) is the Abel-Jacobi map on symmetric \((g-1)\)-fold
products.
