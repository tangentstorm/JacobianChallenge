...
declaration (or a Mathlib reference) and is annotated
\code{\\leanok} when the Lean stub exists,
\code{\\notready} when the statement is still a forward
declaration, or \code{\\mathlibok} when it reduces to a
Mathlib theorem.
...
\begin{lemma}[Smooth-singular ↪ singular is a quasi-isomorphism]
...
\begin{lemma}[Bundled forms step 2: $d, \wedge$ ℝ-linear with the standard identities]
