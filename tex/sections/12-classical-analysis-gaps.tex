...
\begin{theorem}[Gap R9: Bundled differential forms (independent placeholder)]
\label{gap:R9-overview}
\uses{gap:R4-overview,gap:R5-overview,gap:R7-overview}
The Lean target
...
\begin{theorem}[Gap R10: Sobolev / elliptic regularity (independent placeholder)]
\label{gap:R10-overview}
\uses{gap:R5-overview,gap:R9-overview}
The Lean target
