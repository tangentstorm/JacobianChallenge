...
This is a planning node: the eventual Lean proof should use the target-chart
membership leaf and the right-inverse API for open partial homeomorphisms, but
there is not yet a standalone project declaration for this local reconstruction.
\end{lemma}
