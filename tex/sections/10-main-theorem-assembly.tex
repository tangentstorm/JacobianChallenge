...
\uses{thm:genus-zero-classification, def:analytic-jacobian, def:abel-jacobi, lem:aj-self, lem:aj-holomorphic, thm:abel-jacobi-injective, thm:push-pull-functoriality, thm:pushforward-pullback}
The analytic period-lattice construction supplies all definitions and theorems
in the Jacobian Challenge API.
\lean{JacobianChallenge.Solution.genus, JacobianChallenge.Solution.genus_eq_zero_iff_homeo, JacobianChallenge.Solution.Jacobian₀, JacobianChallenge.Solution.Jacobian₀.ofCurve, JacobianChallenge.Solution.Jacobian₀.pushforward, JacobianChallenge.Solution.Jacobian₀.pullback, JacobianChallenge.Solution.Jacobian₀.pushforward_pullback}
\leanok
\end{theorem}
