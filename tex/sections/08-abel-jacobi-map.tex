...
\uses{lem:rr-two-point-dim-geq-two, lem:two-point-pole-realisation}
...
\uses{lem:rr-formula-two-point, lem:rr-formula-combine}
...
non-constants, and the latter must have poles at \(Q_1\) and
\(Q_2\).
\end{layman}
...
must be poles. Why bother? It pins the third-kind data to
...
\uses{lem:rr-formula-general, lem:rr-specialise-two-point}
...
\item
  ...
  r\'egime) and \texttt{riemann\_roch\_strong\_h0\_pos} provide the
