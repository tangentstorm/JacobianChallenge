...
\label{lem:analytic-ofcurve-injective}
...
signature. Open obligation (\lstinline{sorry}) until the genus-zero single-pole
...
\label{lem:pathintegral-separates-points-u}
\uses{thm:abel-point-separation}
...
(\lstinline{sorry}). Consumed by the challenge API (\ref{thm:challenge-api}).
