...
For \(g(X)>0\) the Abel--Jacobi map \(\AJ_P\) is injective. Matches the frozen
public \code{ofCurve\_inj} signature; open obligation (\lstinline{sorry}) until
the genus-zero single-pole route lands.
