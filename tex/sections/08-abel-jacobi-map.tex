...
\uses{def:branched-degree,input:degree-one-isomorphism,thm:riemann-hurwitz-formula,lem:ramification-zero-of-deg-one}
...
\uses{input:divisors,thm:fd-holomorphic-one-forms,input:finite-dimensionality}
