...
\uses{thm:fd-holomorphic-one-forms,thm:abel-existence}
...
\uses{def:period-pairing,thm:period-lattice,input:riemann-bilinear,lem:third-kind-meromorphic-data-exists}
...
\uses{lem:third-kind-meromorphic-data-exists,lem:third-kind-log-period-vanishing}
...
\uses{lem:residue-pairing-third-kind,thm:period-lattice}
...
\uses{lem:third-kind-meromorphic-data-exists,lem:logperiod-vanishing-translation}
...
\uses{lem:single-valued-log-primitive}
...
\uses{thm:input-rr,thm:fd-holomorphic-one-forms}
...
\uses{lem:nonconstant-in-rr,thm:riemann-hurwitz-deg1-basis-aligned}
...
\uses{lem:pathintegrals-in-lattice,lem:residue-pairing-third-kind}
...
\uses{input:divisors,thm:fd-holomorphic-one-forms}
