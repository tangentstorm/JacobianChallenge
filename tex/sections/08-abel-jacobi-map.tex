...
fields. Note: this packaging now requires discharging the analytic-
content fields of \texttt{MeromorphicMapToSphere}
(\texttt{zero\_or\_pole\_eq\_zero},
\texttt{toMap\_ne\_infty\_of\_poleDivisor\_zero}, smoothness, etc.),
which the current Lean repackaging carries as sorries; once a
canonical-zero/pole-decomposition lemma is wired up, the proof
becomes \texttt{leanok}.
\end{proof}
