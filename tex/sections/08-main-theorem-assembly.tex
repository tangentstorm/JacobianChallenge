...
period lattice from section 4, the complex-torus package from
section 5, the Abel--Jacobi map from section 6, and the trace
identity from section 7, and we plug them, one at a time, into
...
trace identity of section 7. Each slot is filled by pointing
