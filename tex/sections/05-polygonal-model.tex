...
\uses{def:tietze-equivalence,def:orientable,lem:tietze-to-handle-grouped,lem:tietze-handle-grouped-to-standard}
...
\uses{def:polygon4g,lem:polygon4g-eq-standard-word-quotient,def:tietze-equivalence,def:orientable,input:rado-triangulation,input:tietze-normal-form,lem:polygonal-model-some-polygon-homeomorph,lem:polygonal-model-genus-matches}
...
\uses{input:de-rham-theorem,lem:hodge-laplacian-kernel-finite-dim,lem:hodge-deRham-iso-harmonic}
...
\uses{def:topological-genus,input:de-rham-theorem,input:hodge-decomposition,input:dolbeault,lem:hodge-deRham-dim-h1-dR,lem:hodge-deRham-rank-eq-dim}
