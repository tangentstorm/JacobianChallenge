...
\uses{def:topological-genus, input:hodge-deRham, lem:cut-along-nontree-unfolded-disk, lem:polygon4g-quotient-path-finite-lift, lem:polygon4g-partial-side-arc-edge-chain, lem:edgechain-sum-boundary-coeff-zero, lem:handleprefix-tailrotate-homeomorph}
...
\label{lem:cut-along-nontree-unfolded-disk}
...
\label{lem:polygon4g-quotient-path-finite-lift}
...
\label{lem:polygon4g-partial-side-arc-edge-chain}
...
\label{lem:edgechain-sum-boundary-coeff-zero}
