...
\uses{def:tietze-equivalence,def:orientable}
...
\uses{def:polygon4g,lem:polygon4g-eq-standard-word-quotient,def:tietze-equivalence,def:orientable,input:rado-triangulation,input:tietze-normal-form,thm:polygon4g-cellular-singular}
...
\uses{def:topological-genus,input:de-rham-theorem,input:hodge-decomposition}
