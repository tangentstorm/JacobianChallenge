...
\begin{theorem}[Classical input: Rad\'o's triangulation theorem]
...
\depends{Classical 1925 result (T. Rad\'o, \emph{\"Uber den Begriff der
Riemannschen Fl\"ache}). Mathlib v4.28.0 has neither the
...
\lean{JacobianChallenge.StageA.rado_triangulation_theorem}
\leanok
\end{theorem}
...
\uses{def:polygon4g,lem:polygon4g-eq-standard-word-quotient,def:tietze-equivalence,def:orientable,input:rado-triangulation,input:tietze-normal-form,lem:polygonal-model-some-polygon-homeomorph,lem:polygonal-model-genus-matches,lem:polygonal-model-overview-stepwise,lem:polygonal-model-phase12-word-quotient,lem:polygonal-model-phase3-tietze-normal-form,lem:polygonal-model-phase3-quotient-lift,lem:polygonal-model-apply-tietze,thm:polygon4g-cellular-singular}
...
complexes, Rad\'o, spanning tree, prism operator, Hurewicz, edge-word
...
sorry-free. On the homology side,
\code{polygon4g\_cellular\_singular\_iso} is now a sorry-free assembly
from \code{polygon4g\_singularH1\_basis}; the remaining frontier is the
positive-genus Hurewicz/cellular computation packaged as
\code{polygon4g\_succ\_hurewicz\_iso\_freeZ}. The umbrella reduction
theorem and the Stage~A bottom-up infrastructure remain open.}
...
leaves are (i) closed disk source, (ii) boundary side subdivision,
(iii) boundary quotient relation, (iv) boundary side-pairing
combinatorics, (v) side-pairing orientation and label compatibility,
(vi) characteristic maps, (vii) realisation as the standard cellular
model, (viii) one-cell boundary zero, (ix) the two-cell abelianised
commutator boundary, (x) singular zero-cell datum, (xi) singular
one-cell edge-path data, (xii) singular two-cell characteristic-map
data, (xiii) singular two-cell boundary-word parametrisation, (xiv)
degree-zero correctness of the comparison map, (xv) one-cell boundary
compatibility, (xvi) two-cell attaching-map compatibility, (xvii)
filtration compatibility, (xviii) the associated-graded \(H_1\)
calculation, and (xix) passage from the filtered graded comparison to
the induced \(H_1\)-isomorphism.
These are precisely the cellular-chain and Hurewicz-style APIs absent
from Mathlib v4.28.0.}
\lean{JacobianChallenge.Periods.polygon4g_cellular_singular_iso,polygon4g_cellular_singular_H1_iso_of_filtered_graded,polygon4g_cellular_singular_associated_graded_H1_iso,polygon4g_cellular_singular_chain_map_degree_one_boundary,polygon4g_cellular_singular_chain_map_degree_two_attaching,polygon4g_cellular_singular_chain_map_degree_zero,polygon4g_cellular_singular_filtration_compatible,polygon4g_cellular_singular_one_cell_data,polygon4g_cellular_singular_two_cell_boundary_word_data,polygon4g_cellular_singular_two_cell_characteristic_data,polygon4g_cellular_singular_zero_cell_data}
\leanok
\end{theorem}
...
For a compact K\"ahler manifold \(X\) (in particular a compact Riemann
...
elliptic-PDE compactness, harmonic-form decomposition, nor K\"ahler
...
\code{deRhamH_iso_Harmonic}, Poincar\'e duality) +
\code{Jacobian/StageB/KahlerStructure.lean}
(Dolbeault \((p,q)\)-decomposition, Hodge symmetry).}
\lean{JacobianChallenge.StageB.hodge_decomposition,hodge_decomposition}
\leanok
\end{theorem}
...
\lean{JacobianChallenge.Periods.hodge_deRham_rank_eq_via_classical_route}
\leanok
\end{theorem}
