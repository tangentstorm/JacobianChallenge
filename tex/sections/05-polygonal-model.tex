...
leaves are (i) quotient-disk cell data, (ii) edge-pairing cell data,
(iii) characteristic maps, (iv) realisation as the standard cellular
model, (v) one-cell boundary zero, (vi) the two-cell abelianised
commutator boundary, (vii) singular zero-cell datum, (viii) singular
one-cell edge-path data, (ix) singular two-cell characteristic-map
data, (x) singular two-cell boundary-word parametrisation, (xi)
degree-zero correctness of the comparison map, (xii) one-cell boundary
compatibility, (xiii) two-cell attaching-map compatibility, (xiv)
filtration compatibility, (xv) the associated-graded \(H_1\)
calculation, and (xvi) passage from the filtered graded comparison to
