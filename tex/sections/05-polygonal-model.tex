...
boundary with the abelianised commutator product, (iii) the
singular zero-cell datum, (iv) singular one-cell edge-path data, (v)
singular two-cell disk and attaching data, (vi) degree-zero correctness
of the comparison map, (vii) one-cell boundary compatibility, (viii)
two-cell attaching-map compatibility, (ix) filtration compatibility,
(x) the associated-graded \(H_1\) calculation, and (xi) passage from
the filtered graded comparison to the induced \(H_1\)-isomorphism.
