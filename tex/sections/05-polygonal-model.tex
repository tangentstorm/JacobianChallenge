...
comparison-data construction, (iv) chain-map correctness, (v)
filtration compatibility, (vi) the associated-graded \(H_1\)
calculation, and (vii) passage from the filtered graded comparison to
