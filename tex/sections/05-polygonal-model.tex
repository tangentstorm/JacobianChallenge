...
\uses{def:topological-genus, input:hodge-deRham, lem:cut-along-non-tree-yields-unfolded-disk, lem:polygon4g-quotient-path-finite-lift-subdivision, lem:polygon4g-partial-side-arc-homologous-to-edge-chain, lem:edge-chain-sum-singular-boundary-scalar-coefficient-zero, lem:handleprefix-tailrotate-homeomorph}
