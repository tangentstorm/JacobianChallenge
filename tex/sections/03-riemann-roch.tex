...
\(\zeros(f)-\poles(f)+[P]\geq 0\). At each \(Q\), use the
disjoint-support property of an actual meromorphic function's
zero/pole divisors to extract the displayed pointwise bound.
\end{proof}
