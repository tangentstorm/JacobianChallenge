...
\uses{lem:entire-tendsto-zero-eq-zero, lem:identity-chart-coeff-contdiff, lem:inversion-chart-coeff-continuous-at-zero, lem:cotangent-transition-formula}
...
Lemma~\ref{lem:identity-chart-coeff-contdiff} supplies the entire coefficient,
while Lemma~\ref{lem:cotangent-transition-formula}, together with continuity in
the inversion chart, gives cocompact decay of \(f\). Applying
...
point. Open obligation (\lstinline{sorry}).
