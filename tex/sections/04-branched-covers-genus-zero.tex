...
fields are real, and the two-chart selector now supplies the target-chart-cover
packaging witness. The remaining missing provider is the construction that
packages the two-chart normalized-limit selector as this global family,
including the source-cover packaging.
