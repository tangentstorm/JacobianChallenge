...
homeomorphism, plus comparison of analytic and topological genus.
...
\uses{thm:exists-biholomorph-one-point-of-genus-zero, lem:holomorphic-one-form-pullback-via-biholo}
...
Theorem~\ref{thm:exists-biholomorph-one-point-of-genus-zero}.
\end{proof}

\begin{theorem}[Biholomorphism from sphere homeomorphism (genus-zero uniformization)]
\label{thm:exists-biholomorph-one-point-of-genus-zero}
\uses{lem:uniformization-genus-zero-homeomorphism, lem:holomorphic-one-form-pointwise-limit-exists, lem:holomorphic-one-form-limit-continuous, lem:holomorphic-one-form-limit-holomorphic}
A compact connected complex 1-manifold homeomorphic to \(S^2\) admits a
...
\code{ContMDiff} in both directions. The simple-pole / degree-one meromorphic
data of the classical proof is then \emph{obtained from} this biholomorphism,
not used to construct it.
\end{proof}

\begin{lemma}[Analytic genus zero gives a sphere biholomorphism (open)]
\label{lem:exists-biholomorph-one-point-of-analytic-genus-zero}
\uses{thm:exists-biholomorph-one-point-of-genus-zero}
A compact connected Riemann surface with \(g_{\mathrm{an}}(X)=0\) admits a
biholomorphism \(X\simeq\code{OnePoint}\,\C\). Packages
Theorem~\ref{thm:exists-biholomorph-one-point-of-genus-zero} into the
\(g_{\mathrm{an}}=0\) hypothesis the meromorphic bridge consumes. Open
obligation (\code{sorry}) in the Lean development.
...
\label{lem:complex-simple-pole-principal-part-of-biholomorph-one-point}
\uses{thm:exists-biholomorph-one-point-of-genus-zero}
...
point. Open obligation (\code{sorry}).
