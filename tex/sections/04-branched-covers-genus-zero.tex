...
chart-ball packages and the coordinate realization for the returned global patch
family. This provider no longer carries a separate source-cover obligation; the
cover is recovered from the returned family's \code{patch_cover} field.
