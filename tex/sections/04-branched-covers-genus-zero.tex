...
\(\Tendsto\,g\) lands in \(\Bornology.cobounded\,\CC\) by
\code{Metric.tendsto\_dist\_right\_atTop\_iff} (with base point
\(0\)). On the proper Hausdorff space \(\CC\),
\(\cobounded=\cocompact=\coclosedCompact\) by
...
\(\iota\circ g\to\infty\) in \(\OnePoint\,\CC\).
\end{proof}
