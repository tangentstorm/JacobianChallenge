...
\uses{lem:uniformization-genus-zero-homeomorphism, lem:montel-chartball-normalized-local-chart}
...
cover, and package the result as a \code{GenusZeroGlobalPatchFamily}. No
green Lean declaration currently packages this finite global extraction.
\end{lemma}
