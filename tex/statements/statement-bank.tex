...
\uses{input:riemann-bilinear, def:period-pairing, thm:analytic-eq-topological-genus, lem:h1-basis-compact-rs-u, lem:riemann-classical-real-li-input-u}
...
\label{lem:h1-basis-compact-rs-u}
A \(\Z\)-basis of \(H_1\) for a universe-\(u\) compact Riemann surface
(\(\code{IntegralOneCycleU}\)). Open obligation (\lstinline{sorry}).
...
input. Open obligation (\lstinline{sorry}).
