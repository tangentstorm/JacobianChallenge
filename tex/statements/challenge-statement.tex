...
\code{IsManifold 𝓘(ℂ) ω X} in the Lean target). The challenge fixes
...
finite-dimensionality theorem (Section 2) makes this an honest natural
number. By the genus-zero classification below, this number also matches
...
challenge. The proof chain (worked out in detail in Section~8):
