...
\uses{input:finite-dimensionality,input:degree-one-isomorphism,def:analytic-genus,thm:analytic-eq-topological-genus,lem:holomorphic-one-form-linearEquiv-to-OnePointCx,thm:homeo-sphere-holomorphic-one-form-vanishing,thm:degree-one-bijectivity-meromorphic}
