...
\uses{input:finite-dimensionality,prop:genus-zero-degree-one-map,input:degree-one-isomorphism,def:analytic-genus,thm:analytic-eq-topological-genus,lem:holomorphic-one-form-linearEquiv-to-OnePointCx}
