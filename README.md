...
Last tick: 2026-04-27 09:44 EDT
...
Integrated this tick (local Claude-owned, 4 lemmas):
                      NEW TraceDegree.PullbackFunIdEvalVecExtra:
                      sub/nsmul/zsmul vec-slot distributivity plus
                      double-neg-vec for pullback-along-id.
