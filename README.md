...
Last tick: 2026-04-27 08:08 EDT
...
Abel-Jacobi API                  ████░░░░░░░░░░░░░░░░   20%  witness skeleton + composition + vec-slot algebra + base-change + explicit `witness + basePoint-class = endpoint-class` identities
...
Integrated this tick (local Claude-owned, 4 lemmas):
                      NEW AbelJacobi.Identities: explicit
                      `witness + basePoint-class = endpoint-class`,
                      symmetric form, chain-shift alias, and
                      `_left_self_eq_zero` simp.
