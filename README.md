...
Last tick: 2026-04-27 10:03 EDT
...
Trace/degree/push-pull           ██████░░░░░░░░░░░░░░   32%  pullbackFormsFun: full linearity + LinearMap bundle + id + comp-id/comp-const + const-of-const + mixed const/id + id-of-id + light bridge to HolomorphicForms.evalLinearMap + bundled along-id vec/form-slot full linearity (zero/add/neg/sub/smul/nsmul/zsmul)
...
Integrated this tick (local Claude-owned, 4 lemmas):
                      NEW TraceDegree.PullbackFormsLinearMapIdEvalSmul:
                      bundled along-id form-slot ℕ/ℤ-smul + neg-zero
                      + zero-sub-zero, via `evalLinearMap_{n,z}smul`.
