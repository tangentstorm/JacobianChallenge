...
Last tick: 2026-04-27 06:28 EDT
...
Holomorphic forms                █████████░░░░░░░░░░░   47%  type/module/analyticGenus + positivity API + full toFun matrix + `evalLinearMap` (neg/sub/smul/nsmul/zsmul) + extensionality (ext_toFun, ext_toFun_apply)
...
Integrated this tick (local Claude-owned, 4 lemmas):
                      NEW HolomorphicForms.Ext: extensionality
                      principles `ext_toFun_iff`, `ext_toFun`,
                      `ext_toFun_apply_iff`, `ext_toFun_apply`.
                      Repackages ContMDiffSection.ext at the
                      `.toFun` projector level.
