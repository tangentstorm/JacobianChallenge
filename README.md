...
Last tick: 2026-04-27 06:01 EDT
...
Holomorphic forms                ████████░░░░░░░░░░░░   41%  type/module/analyticGenus + zero/positivity API + full toFun simp matrix (zero/neg/add/sub/smul/nsmul; apply + vec-apply)
...
Integrated this tick (local Claude-owned, 4 lemmas):
                      NEW HolomorphicForms.ToFunApplyVecExtra:
                      sub/smul vec-apply + nsmul (apply +
                      vec-apply). Fully closes the toFun simp
                      matrix at both apply levels.
