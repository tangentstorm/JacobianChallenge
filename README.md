...
Last tick: 2026-04-27 06:32 EDT
...
Holomorphic forms                █████████░░░░░░░░░░░   48%  type/module/analyticGenus + positivity API + full toFun matrix + `evalLinearMap` (neg/sub/smul/nsmul/zsmul) + extensionality through `evalLinearMap`
...
Integrated this tick (local Claude-owned, 4 lemmas):
                      NEW HolomorphicForms.ExtEvalLinearMap:
                      extensionality through `evalLinearMap`,
                      a `_eq_zero_iff_evalLinearMap_eq_zero`
                      criterion, and a non-vanishing witness
