...
theorem H1_structureSheaf_iso_dual_H0_canonicalSheaf : True := sorry

/-- Dimensional form: `dim_ℂ H¹(X, 𝒪) = dim_ℂ H⁰(X, Ω¹) = analyticGenus ℂ X`. -/
theorem H1_structureSheaf_finrank_eq_analyticGenus : True := sorry
...
`⟨α, β⟩ ≠ 0`). -/
theorem serre_pairing_separating_first (_F : Type) (_q : ℕ) : True := sorry

/-- **Round 4.** *Sub-leaf:* same in the second slot. -/
theorem serre_pairing_separating_second (_F : Type) (_q : ℕ) : True := sorry
