...
primitive primitive primitive exactness split.** This is the remaining
comparison input before exactness packaging applies.
-/
theorem deRhamComparisonMap1_zero_period_primitive_for_direct_primitive_exactness_primitive_primitive_primitive_primitive_primitive_frontier
  ...
  -- Direct primitive exactness primitive primitive primitive primitive primitive frontier.
  sorry
