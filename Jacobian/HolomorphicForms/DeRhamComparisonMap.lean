...
primitive primitive vanishing split.** This is the remaining comparison input
before exact-form vanishing applies.
-/
theorem deRhamComparisonMap1_zero_period_exact_for_direct_primitive_exactness_primitive_primitive_primitive_primitive_primitive_frontier
  ...
  -- Direct primitive exactness primitive primitive primitive primitive exactness frontier.
  sorry
