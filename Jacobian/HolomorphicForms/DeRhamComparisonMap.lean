...
primitive primitive primitive primitive split.** This is the remaining
comparison input before primitive-existence packaging applies.
-/
theorem deRhamComparisonMap1_zero_period_path_integral_derivative_for_direct_primitive_exactness_primitive_primitive_primitive_primitive_primitive_primitive_frontier
  ...
  -- Direct primitive exactness primitive primitive primitive primitive primitive derivative frontier.
  sorry
